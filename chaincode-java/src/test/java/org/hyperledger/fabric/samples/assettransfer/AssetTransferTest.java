...
public final class AssetTransferTest {
    ...
    class InvokeDuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            when(stub.getStringState("asset1"))
                    .thenReturn("{ \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"Tomoko\", \"appraisedValue\": 300 }");
            Asset duplicateAsset = contract.DuplicateAsset(ctx, "asset1", "duplicatedAssetOwner");
            assertThat(duplicateAsset).isEqualTo(new Asset("asset1Duplicate", "blue", 5, "duplicatedAssetOwner", 300));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "duplicatedAssetOwner");
            });
